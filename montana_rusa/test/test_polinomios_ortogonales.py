...
from src.principal import polinomio_ortogonal

class TestOrtogonal(unittest.TestCase):
    def test_polinomio_ortogonal(self):
        ...
        polinomio = polinomio_ortogonal(x_datos,y_datos,x_values)
        np.testing.assert_allclose(polinomio,polinomio, atol=0.1)
